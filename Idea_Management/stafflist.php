...
<div class="container-fluid al">
  ...
  <button onclick="window.location='CreateStaff.php'" class="nv btn add-new" type="button" data-toggle="tooltip" data-placement="top" title="Add Post" style="float:right; background-color:  #008000">Create 
  </button>
    ...
    <table class="table table-bordered" id="myTable">
      ...
      if (isset($_GET["function"]) == "del") {
        if (isset($_GET["id"])) {
          ...
          mysqli_query($conn, "DELETE FROM account WHERE account_Id='$id'");
            ...
            <tr>
              ...
              <td>
                <div class="text-center">
                  <button class="btn btn-primary btn-sm edit" style="background-color:#38b000" type="button" onclick="window.location.href='editstaff.php?id=<?php echo $row['account_Id']; ?>'">

...
<body>
  ...
  if (isset($_POST["btnAdd"])) {
    ...
    $sqlstring = "INSERT INTO  account (fullname, gender, department_Id, role, date_of_birth, address,phone,email,password) VALUES ('$fullname','$gender','$department','0','$birthdaytime','$address','$phonenumber','$email','e10adc3949ba59abbe56e057f20f883e')";

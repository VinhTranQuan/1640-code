...
<body>
  ...
  if (isset($_SESSION['username'])) {
    ...
    $sqlString = "SELECT * from account where email= '$admin'";
  ...
  if (isset($_POST["btnAdd"])) {
    ...
    $sqlstring = "INSERT INTO post (title, content, date_ending, category_Id, department_Id, account_Id,date_end_read,active ) VALUES ('$title','$content','$date_ending','$category','$department','$account_Id','$date_end_read','1')";
  ...
  <form action="" method="post" enctype="multipart/form-data">
    ...
    <input type="button" value="Cancel" onclick="window.location='listpost.php'" />  </form>
</body>

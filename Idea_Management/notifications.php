...
$find_notifications = "SELECT c.*, a.fullname FROM comment c JOIN account a ON c.account_Id = a.account_Id WHERE a.department_Id = $department_id AND active = 1" ;
...
$find_post = "SELECT p.*, a.fullname  FROM post p JOIN account a ON p.account_Id = a.account_Id WHERE a.department_Id = $department_id AND active = 1";

...
if (isset($_GET['id'])) {
  $id = $_GET['id'];
  $sqlString = "SELECT *from feedback WHERE feedback_Id = '$id'";
  ...
  if (isset($_POST['like'])) {
    ...
    $row = mysqli_fetch_array($result);
    $result2 = mysqli_query($conn, "SELECT * FROM account WHERE email = '$user_id'");
    ...
    $sql = "UPDATE feedback SET likes = $likes, liked_by = '$liked_by' WHERE feedback_Id = '$feedback_id'";
    ...
    <div class="comment-container">
      <form method='POST'>
        ...
        <div class="actions">
          ...
          <a style="color:white">Like</a>: <?php echo $row['likes'] ?>
          </button>
        </div>
      </form>
      <h2>Comments</h2>
...
if (isset($_POST['submit'])) {
  ...
  if (!empty($content)) {
    ...
    $sql = "INSERT INTO comment (content, feedback_Id, account_Id,active) VALUES ('$content','$id','$account','1')";

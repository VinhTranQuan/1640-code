    ...
    <nav class="navbar navbar-default navbar-fixed-top">
      <div class="container-fluid">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php"><img src="images/FGW_logo_d.jpg" alt="#" style="width:100px;height:50px;"></i></a>
        </div>
        <div class="collapse navbar-collapse" id="myNavbar">
          <ul class="nav navbar-nav navbar-right">
            ...
            <li>
            <a href="departmentlist.php" data-toggle="tooltip" data-placement="bottom" title="Staff">QA List</a>
            </li>                    
            <li>
